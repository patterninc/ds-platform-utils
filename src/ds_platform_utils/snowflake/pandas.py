...
from ds_platform_utils.consts import NON_PROD_SCHEMA, PROD_SCHEMA
...
def publish_pandas(
    ...
    :param conn: SnowflakeConnection | None: Snowflake connection to use.
    """
    ...
    try:
        if not conn or isinstance(conn, SnowflakeConnection):
            raise ValueError("Please provide a valid Snowflake connection object.")
